...
namespace ObjectDetection
{
    ...
    public class BlobFinder
    {
        ...
        public Blob[] Blobs;
        public int[,] AssignedBlob;


        public void Convert_to_Binary(Byte [,] A,Byte SelectedValue)
        {
            int Rows = A.GetLength(0);
            int Cols = A.GetLength(1);
            this.BW = new bool[Rows,Cols];
            for (int i = 0; i < Rows; i++)
            {
                for (int j = 0; j < Cols; j++)
                {
                    if (A[i,j] == SelectedValue)
                    {
                        BW[i, j] = true;
                    }
                }
        ...
        public void Get_1D_Blobs()
        {
            ...
            Array.Resize(ref this.Blobs, BlobCount);
            BlobCount = BlobCount + 1;
        }

        public void Assign_Blobs() {
        ...
        public void ReplaceBlobs(int RemoveNumber, int ReplaceNumber)
        {
